...
<!DOCTYPE html>
    ...
    var fname = document.getElementsByName('doc_fname')[0].value;
    var lname = document.getElementsByName('doc_lname')[0].value;
    var email = document.getElementsByName('doc_email')[0].value;
    var dpic = document.getElementsByName('doc_dpic')[0].value;
    ...
    function validatePasswordForm() {
        var oldPwd = document.getElementById('firstname').value;
        var newPwd = document.getElementById('lastname').value;
        var confirmPwd = document.getElementById('useremail').value;
